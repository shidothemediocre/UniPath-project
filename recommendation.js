...
function showResults(marks, majors, region) {
  ...
  if (matched.length === 0) {
    list.innerHTML = "<li>No universities match all your choices. Try different majors or region, or browse the full list on <a href='universities.html'>Universities page</a>.</li>";
  } else {
